  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-3xl animate-pulse"></div>
        
        <div className="relative z-10 text-center max-w-lg mx-auto">
          {/* Icon Container */}
          <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-linear-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 flex items-center justify-center border-4 border-blue-200 dark:border-blue-800 shadow-2xl">
            <TruckIcon className="w-16 h-16 text-blue-600 dark:text-blue-400" />
          </div>
          
          {/* Title */}
          <h1 className="text-4xl md:text-5xl font-bold bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent mb-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1 flex-wrap">
                            ...
                            {isExpired && (
                              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-linear-to-r from-red-100 to-rose-500 dark:from-red-900/50 dark:to-rose-900/40 text-red-800 dark:text-red-300 border border-red-300 dark:border-red-700 shadow-sm animate-pulse">
