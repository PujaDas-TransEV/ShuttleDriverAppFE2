...
const DriverVehicle: React.FC = () => {
  ...
  const fetchVehicle = async () => {
    ...
    try {
      ...
      // If 404, no vehicle found - show empty state
      if (res.status === 404) {
        setVehicleData(null);
        setLoading(false);
        return;
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
      <div className="relative">
        ...
        <div className="relative z-10 text-center max-w-lg mx-auto">
          {/* Icon Container */}
          <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 flex items-center justify-center border-4 border-blue-200 dark:border-blue-800 shadow-2xl">
            <TruckIcon className="w-16 h-16 text-blue-600 dark:text-blue-400" />
          </div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg mb-8 leading-relaxed">
            Get started by adding your vehicle details. This will help you manage trips, 
            track performance, and start earning with Shuttle.
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Vehicle Registration</p>
            </div>
            <div className="p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
              <div className="text-2xl mb-2">📄</div>
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Document Upload</p>
            </div>
            <div className="p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
              <div className="text-2xl mb-2">✅</div>
            ...
            <div className="p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
              <div className="text-2xl mb-2">💰</div>
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Start Earning</p>
            </div>
          </div>
          
          {/* Add Vehicle Button */}
         <button
  onClick={() => history.push('/vehicle-registration')}
  style={{
    minWidth: '220px',
    width: 'auto',
    height: '52px',
    ...
    justifyContent: 'center',
    gap: '12px',
    boxShadow: '0 8px 25px -5px rgba(59, 130, 246, 0.4), 0 4px 10px -3px rgba(59, 130, 246, 0.2)',
  ...
  onMouseEnter={(e) => {
    ...
    e.currentTarget.style.boxShadow = '0 12px 35px -5px rgba(59, 130, 246, 0.5), 0 6px 15px -3px rgba(59, 130, 246, 0.3)';
    e.currentTarget.style.background = 'linear-gradient(135deg, #2563EB, #6D28D9)';
  }}
  onMouseLeave={(e) => {
    e.currentTarget.style.transform = 'scale(1) translateY(0)';
    e.currentTarget.style.boxShadow = '0 8px 25px -5px rgba(59, 130, 246, 0.4), 0 4px 10px -3px rgba(59, 130, 246, 0.2)';
    e.currentTarget.style.background = 'linear-gradient(135deg, #3B82F6, #7C3AED)';
  }}
>
  <PlusCircleIcon style={{ width: '24px', height: '24px', transition: 'transform 0.3s ease' }} />
  ...
  />
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-6">
            ⏱️ Takes less than 5 minutes • Secure & Verified
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="max-w-5xl mx-auto p-6 space-y-6 mt-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 to-gray-800 dark:from-white dark:to-gray-800 bg-clip-text text-transparent">
                Vehicle Details
              </h1>
              <p className="text-gray-500 dark:text-gray-400 mt-2">
                Complete vehicle information and verification status
            ...
            {/* Add Vehicle Button - Only show if no vehicle */}
            {!vehicleData && (
             <button
  onClick={() => history.push('/vehicle-registration')}
  style={{
  ...
  onMouseEnter={(e) => {
    e.currentTarget.style.transform = 'scale(1.05)';
    e.currentTarget.style.boxShadow = '0 8px 25px -4px rgba(59, 130, 246, 0.5)';
    e.currentTarget.style.background = 'linear-gradient(135deg, #2563EB, #6D28D9)';
  }}
  onMouseLeave={(e) => {
    e.currentTarget.style.transform = 'scale(1)';
    e.currentTarget.style.boxShadow = '0 4px 14px -4px rgba(59, 130, 246, 0.4)';
    e.currentTarget.style.background = 'linear-gradient(135deg, #3B82F6, #7C3AED)';
  }}
>
  ...
  <span>Add Vehicle</span>
          ...
          {/* Show Empty State or Vehicle Data */}
          {!vehicleData ? (
            <EmptyState />
          ) : (
            <>
              ...
              {vehicleInspection && vehicleInspection.vehicle_id && (
                <div className={`rounded-2xl border-2 ${inspectionBadge.borderColor} overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl`}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1 flex-wrap">
                            ...
                            {!isExpired && daysUntilDue !== null && daysUntilDue <= 15 && daysUntilDue > 0 && (
                              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-purple-100 to-fuchsia-100 dark:from-purple-900/40 dark:to-fuchsia-900/40 text-purple-800 dark:text-purple-300 border border-purple-200 dark:border-purple-700 shadow-sm">
                                <ClockIcon className="w-3.5 h-3.5 text-purple-500" />
                                Due in {daysUntilDue} {daysUntilDue === 1 ? 'day' : 'days'}
                              </span>
                            )}
                            {isExpired && (
                              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-red-100 to-rose-500 dark:from-red-900/50 dark:to-rose-900/40 text-red-800 dark:text-red-300 border border-red-300 dark:border-red-700 shadow-sm animate-pulse">
                                <ExclamationTriangleIcon className="w-3.5 h-3.5 text-red-500" />
                                Overdue by {Math.abs(daysUntilDue!)} {Math.abs(daysUntilDue!) === 1 ? 'day' : 'days'}
                              </span>
                            )}
                  ...
                  {/* Inspection Details - Expandable */}
                  {showInspectionDetails && (
                    <div className="p-5 border-t border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="flex items-start gap-3 p-3 rounded-xl bg-white/50 dark:bg-gray-800/30 backdrop-blur-sm">
                          <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                            <CalendarIcon className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                          ...
                          <div className="relative overflow-hidden rounded-2xl p-5 transition-all duration-300 hover:shadow-xl group">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-purple-950/30 transition-all duration-500 group-hover:scale-105"></div>
                            <div className="absolute -top-10 -right-10 w-32 h-32 rounded-full bg-blue-200/30 dark:bg-blue-500/10 blur-2xl"></div>
                            <div className="absolute -bottom-10 -left-10 w-32 h-32 rounded-full bg-purple-200/30 dark:bg-purple-500/10 blur-2xl"></div>
                            <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-t-2xl transform origin-left transition-transform duration-500 group-hover:scale-x-100"></div>
                            <div className="relative z-10">
                              <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-3">
                                  <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/30 transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-6">
                                    <CalendarIcon className="w-6 h-6 text-white" />
                                    <div className="absolute inset-0 rounded-xl border-2 border-blue-400/50 animate-ping"></div>
                                  </div>
                                  <div>
                                ...
                                {vehicleInspection.inspection_reviewed_at && (
                                  <div className="px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/50 dark:to-emerald-900/50 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800 shadow-sm flex items-center gap-1.5">
                                    <CheckBadgeIcon className="w-3.5 h-3.5" />
                                    Verified
                                  </div>
                                )}
                              ...
                              <div className="relative mt-4 mb-4 ml-2">
                                <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-indigo-500 to-purple-500 rounded-full"></div>
                                <div className="absolute left-0 top-0 w-2 h-2 rounded-full bg-blue-500 -translate-x-0.75 animate-pulse"></div>
                                <div className="absolute left-0 bottom-0 w-2 h-2 rounded-full bg-purple-500 -translate-x-0.75"></div>
                              </div>
                              <div className="mt-4 p-4 rounded-xl bg-white/60 dark:bg-gray-800/40 backdrop-blur-sm border border-blue-100 dark:border-blue-900/50 shadow-sm transition-all duration-300 hover:shadow-md hover:bg-white/80 dark:hover:bg-gray-800/60">
                                <div className="flex items-start gap-3">
                                  <div className="shrink-0">
                                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 flex items-center justify-center">
                                      <CheckBadgeIcon className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                                    </div>
                                  </div>
                                  <div className="flex-1">
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-xl bg-white/50 dark:bg-gray-800/30 backdrop-blur-sm">
                          ...
                          <div className="relative overflow-hidden rounded-2xl p-5 transition-all duration-300 hover:shadow-xl group">
                            <div className={`
                              ...
                              ${isExpired 
                                ? 'bg-gradient-to-br from-red-50 via-rose-50 to-orange-50 dark:from-red-950/40 dark:via-rose-950/40 dark:to-orange-950/40' 
                                : isDueSoon 
                                ? 'bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-amber-950/40 dark:via-orange-950/40 dark:to-yellow-950/40'
                                : 'bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-emerald-950/40 dark:via-green-950/40 dark:to-teal-950/40'
                              }
                            `}></div>
                            <div className="absolute -top-10 -right-10 w-32 h-32 rounded-full bg-white/30 dark:bg-white/5 blur-2xl"></div>
                            <div className="absolute -bottom-10 -left-10 w-32 h-32 rounded-full bg-white/30 dark:bg-white/5 blur-2xl"></div>
                            <div className={`
                              absolute top-0 left-0 right-0 h-1.5 rounded-t-2xl transition-all duration-500
                              ${isExpired ? 'bg-gradient-to-r from-red-500 via-rose-500 to-orange-500 animate-pulse' : 
                                isDueSoon ? 'bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500' : 
                              ...
                              <div className="flex items-start justify-between mb-4">
                                ...
                                <div className={`
                                  ...
                                  ${isExpired 
                                    ...
                                    : isDueSoon 
                                    ? 'bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/50 dark:to-orange-900/50 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800'
                                    : 'bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/50 dark:to-teal-900/50 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800'
                                  }
                                `}>
                                  {isExpired && `OVERDUE by ${Math.abs(daysUntilDue!)} day${Math.abs(daysUntilDue!) !== 1 ? 's' : ''}`}
                                  {isDueSoon && !isExpired && `${daysUntilDue} day${daysUntilDue !== 1 ? 's' : ''} remaining`}
                                ...
                                <div className="w-full h-2.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                  <div 
                                    className={`
                                      h-full rounded-full transition-all duration-1000 ease-out
                                      ${isExpired 
                                        ? 'bg-gradient-to-r from-red-500 to-rose-500 w-full animate-shake' 
                                        : isDueSoon 
                        ...
                        {vehicleInspection.inspection_reason && (
                          <div className="md:col-span-2">
                            <div className="relative overflow-hidden rounded-2xl p-5 transition-all duration-300 hover:shadow-2xl group">
                              <div className="absolute inset-0 bg-gradient-to-br from-rose-50 via-red-50 to-pink-50 dark:from-rose-950/40 dark:via-red-950/40 dark:to-pink-950/40 transition-all duration-500 group-hover:scale-105"></div>
                              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-rose-500 via-red-500 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-xl"></div>
                              <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-rose-200/40 dark:bg-rose-500/10 blur-3xl"></div>
                              <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full bg-red-200/40 dark:bg-red-500/10 blur-3xl"></div>
                              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-rose-500 via-red-500 to-pink-500 rounded-t-2xl transform origin-left transition-transform duration-500 group-hover:scale-x-100"></div>
                              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                              <div className="relative z-10">
                                <div className="flex items-start justify-between mb-4">
                                  <div className="flex items-center gap-3">
                                    <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-rose-500 to-red-600 flex items-center justify-center shadow-lg shadow-rose-500/30 transform transition-all duration-300 group-hover:scale-110 group-hover:-rotate-6">
                                      <XCircleIcon className="w-6 h-6 text-white" />
                                      <div className="absolute inset-0 rounded-xl border-2 border-rose-400/50 animate-ping"></div>
                                    </div>
                                    <div>
                                  ...
                                  <div className="px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-rose-100 to-red-100 dark:from-rose-900/50 dark:to-red-900/50 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-800 shadow-sm flex items-center gap-1.5 animate-pulse">
                                    <XCircleIcon className="w-3.5 h-3.5" />
                                    Rejected
                                  </div>
                                </div>
                                <div className="mt-4 p-5 rounded-xl bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm border border-rose-200 dark:border-rose-800/50 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:bg-white/80 dark:group-hover:bg-gray-900/70">
                                  <div className="flex items-start gap-4">
                                    <div className="shrink-0">
                                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-rose-100 to-red-100 dark:from-rose-900/40 dark:to-red-900/40 flex items-center justify-center border border-rose-200 dark:border-rose-800">
                                        <DocumentTextIcon className="w-5 h-5 text-rose-600 dark:text-rose-400" />
                                      </div>
                                    </div>
                                    <div className="flex-1">
              ...
              {!isEditing ? (
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                  {/* Header with Edit Button */}
                  <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800/50 dark:to-gray-800">
                    <div className="flex justify-between items-center flex-wrap gap-4">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-black dark:bg-white rounded-xl">
                          <TruckIcon className="w-5 h-5 text-white dark:text-black" />
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    {/* RFID Info Card */}
                    {(vehicleData.default_rfid_reserved_seat_count || 0) > 0 && (
                      <div className="rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-2 border-purple-200 dark:border-purple-800 overflow-hidden">
                        <div className="p-4">
                          <div className="flex items-center gap-3 mb-3">
                            <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                              <WifiIcon className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                    ...
                    {isRfidEditAllowed && (
                      <div className="space-y-4">
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                          ...
                          <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border border-purple-200 dark:border-purple-800">
                            <div className="flex items-center gap-3">
                              <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                                <WifiIcon className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                              </div>
          ...
          <div className="text-center py-4">
            <input 
              ...
              className="w-full text-sm text-gray-600 dark:text-gray-400
                       file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0
                       file:text-sm file:font-semibold 
                       file:bg-gradient-to-r file:from-red-500 file:to-orange-500
                       file:text-white file:shadow-md
                       hover:file:from-red-600 hover:file:to-orange-600
                       hover:file:shadow-lg
                       cursor-pointer transition-all duration-200
