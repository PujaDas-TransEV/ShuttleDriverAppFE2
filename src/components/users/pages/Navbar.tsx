...
//   const [passengerMenuOpen, setPassengerMenuOpen] = useState(false); // Passenger menu state
...
//                   </div>
//                   {item.submenu && (
//                     (isFineMenu && fineMenuOpen) || (isTripMenu && tripMenuOpen) || (isPassengerMenu && passengerMenuOpen) ? 
//                       <ChevronUpIcon style={{ width: '18px', height: '18px', color: '#9CA3AF' }} /> : 
//                       <ChevronDownIcon style={{ width: '18px', height: '18px', color: '#9CA3AF' }} />
//                   )}
//                 </button>

//                 {/* Submenu for Passenger Management */}
//                 {item.submenu && ((isPassengerMenu && passengerMenuOpen) || (isFineMenu && fineMenuOpen) || (isTripMenu && tripMenuOpen)) && (
//                   <div style={{
//                     marginLeft: '32px',
//                     marginTop: '4px',
//                     paddingLeft: '12px',
...
//                           onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
//                         >
//                           {SubIcon && <SubIcon style={{ width: '16px', height: '16px', color: '#6B7280' }} />}
  ...
  return (
    <>
      ...
      <div style={{
        ...
        left: 0,
        right: 0,
        height: '84px',  // Increased from 70px to 84px
        backgroundColor: '#0A0A0A',
        zIndex: 50,
        display: 'flex',
        alignItems: 'center',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          {/* Profile Section - Positioned lower with bottom margin */}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '8px' }}>
          <button
            ...
            style={{
              ...
              border: 'none',
              borderRadius: '40px',
              padding: '12px',  // Larger padding for better touch area
              cursor: 'pointer',
              position: 'relative',
              transition: 'all 0.2s',
              display: 'flex',
