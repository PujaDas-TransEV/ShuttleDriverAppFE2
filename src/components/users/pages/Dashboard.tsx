...
//   // Permission states (same as LiveTracking)
//   const [locationPermissionGranted, setLocationPermissionGranted] = useState(false);
//   const [cameraPermissionGranted, setCameraPermissionGranted] = useState(false);
//   const [notificationPermissionGranted, setNotificationPermissionGranted] = useState(false);
//   const [loadingLocation, setLoadingLocation] = useState(false);
...
//   // ======================
//   // PERMISSION HANDLERS (SAME AS LIVETRACKING)
//   // ======================
...
//   // Initialize permissions on mount (after token is loaded)
//   useEffect(() => {
//     if (token) {
...
//             <p className="text-white font-medium">Checking permissions...</p>
//           </div>
//         </IonContent>
//       </IonPage>
//     );
...
//           {/* Permission Status Bar - Same as LiveTracking */}
//           {isNative && (
//             <div className="mb-4 flex flex-wrap gap-2 justify-center">
//               <div className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs ${
//                 locationPermissionGranted 
...
//           {/* Location Error Banner - Same as LiveTracking */}
//           {locationError && (
...
//               <button
//                 onClick={() => showSequentialPermissions()}
//                 className="px-3 py-1 bg-yellow-500 text-white rounded-lg text-xs font-medium"
//               >
//                 Enable
//               </button>
//             </div>
...
//         {/* Earnings Modal (keep your existing modal code) */}
//         {showEarningsModal && (
//           <div 
//             className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-9999 p-4" 
//             onClick={() => setShowEarningsModal(false)}
...
//         {/* Permission Alert Dialog - Same as LiveTracking */}
//         <IonAlert
//           isOpen={showPermissionAlert}
//           onDidDismiss={() => setShowPermissionAlert(false)}
//           header="Permission Required"
...
//     const interval = setInterval(updatePosition, 30000);
//     return () => clearInterval(interval);
//   }, [locationPermissionGranted, isNative]);
