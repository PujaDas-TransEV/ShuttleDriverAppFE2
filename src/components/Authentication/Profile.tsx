...
//         profileImage: data.profile_picture_path ? `${API_BASE}/${data.profile_picture_path.replace(/\\/g, '/')}` : ''
//       });
//       setImagePreview(data.profile_picture_path ? `${API_BASE}/${data.profile_picture_path.replace(/\\/g, '/')}` : null);
//       setIsCreated(true);
//     } catch (err) {
...
//             >
//               {imagePreview ? (
//                 <img src={imagePreview as string} alt="Profile" className="w-full h-full object-cover" />
//               ) : (
